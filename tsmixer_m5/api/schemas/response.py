...
class Quantiles(BaseModel):
    ...
    p10: list[float] = Field(..., description="10th percentile forecast quantile")
    p50: list[float] = Field(..., description="50th percentile forecast quantile (median)")
    p90: list[float] = Field(..., description="90th percentile forecast quantile")
