...
from hier_forecast.api.config import config
from hier_forecast.api.runner import ModelRunner
from hier_forecast.api.schemas.response import ErrorResponse
from hier_forecast.api.store import InferenceStore
from hier_forecast.api.v1.forecast import router as forecast_router
from hier_forecast.api.v1.health import router as health_router
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        runner = ModelRunner(model=model, category_maps={}, device=config.device, use_amp=False)

    store = InferenceStore(
        category_maps=runner.category_maps,
        snapshot_dir=config.data_snapshot_dir,
