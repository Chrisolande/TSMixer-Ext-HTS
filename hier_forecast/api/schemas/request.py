...
class SeriesKey(BaseModel):
    ...
    item_id: str = Field(..., json_schema_extra={"example": "HOBBIES_1_000_CA_1"}, description="M5 item identifier")
...
class ForecastRequest(BaseModel):
            ...
            "examples": [
                {
                    ...
                    "items": [{"store_id": "CA_1", "item_id": "HOBBIES_1_000_CA_1"}],
    ...
    as_of_date: str = Field(
        ..., json_schema_extra={"example": "2011-04-01"}, description="Forecast origin date (YYYY-MM-DD)"
    )
